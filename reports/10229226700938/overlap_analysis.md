...
| IN_RANGE   |    99 |       91.7% | May exist in G2, not top-100   |
| NEW        |     9 |        8.3% | Genuinely new options          |
...
G2 fetched: 98 groups, price range $782 – $3,450 total
G4 fetched: 52 groups → 156 derived adjacent pairs

| Bucket     | Count | % of derived | Notes                          |
|------------|-------|--------------|--------------------------------|
| DUPLICATE  |     0 |        0.0% | Already in G2 response         |
| IN_RANGE   |   147 |       94.2% | May exist in G2, not top-100   |
| NEW        |     9 |        5.8% | Genuinely new options          |
...
Pairs eligible for merge (NEW below G2 min $782): 0
...
|----------|-------------|-----------|----------------|-----------------|
| Cat 1    |       0.0% |         9 |             99 | DERIVE          |
| Cat 2    |       0.0% |         9 |            147 | DERIVE          |
